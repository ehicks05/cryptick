...
import { get24HourStats, getCurrencies, getDailyCandles, getProducts } from './api';
import { DEFAULT_SELECTED_PRODUCT_IDS, SOCKET_STATUSES, WS_URL } from './constants';
...
const DataFetcher = () => {
	...
	useEffect(() => {
		setWebsocketReadyState(readyState as unknown as keyof typeof SOCKET_STATUSES);
